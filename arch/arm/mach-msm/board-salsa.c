...
static unsigned audio_gpio_on_v03[] = {
	...
	GPIO_CFG(29, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),	/* FM2018_CLK_EN */
	GPIO_CFG(116, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),/* FM2018_1.8V_EN */
	GPIO_CFG(150, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),/* Bypass_Normal */
	GPIO_CFG(148, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),/* FM2018_RESET */
	GPIO_CFG(101, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),/* FM2018_PWD */
#endif
...
static unsigned audio_gpio_on[] = {
	...
	GPIO_CFG(29, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),	/* FM2018_CLK_EN */
	GPIO_CFG(116, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),/* FM2018_1.8V_EN */
	GPIO_CFG(117, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),/* Bypass_Normal */
	GPIO_CFG(125, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),/* FM2018_RESET */
	GPIO_CFG(126, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),/* FM2018_PWD */
